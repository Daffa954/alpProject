<header class="bg-[#f6f6f6]">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" type="button"
                    class="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900" :aria-expanded="open">
                    Product
    ...
    <div class="lg:hidden" role="dialog" aria-modal="true" x-data="{ isOpen2: true }">
        <!-- Background backdrop -->
        <div x-show="isOpen2" x-cloak
        ...
        class="fixed inset-0 bg-gray-500 opacity-75 z-10"></div>
        ...
        x-transition:leave-end="opacity-0"
            ...
            <div class="flex items-center justify-between">
                ...
                <button @click="isOpen2 = !isOpen2" type="button" class="-m-2.5 rounded-md p-2.5 text-blue-700">
                    ...
                    <div class="space-y-2 py-6">
                        <div class="-mx-3" x-data="{ isOpen: false }">
                            ...
                            <div class="mt-2 space-y-2" id="disclosure-1" x-show="isOpen" x-cloak
                                ...
                                <a href="#"
                                    class="block rounded-lg py-2 pl-6 pr-3 text-sm/7 font-semibold text-gray-900 hover:bg-gray-50">Watch demo</a>
                                <a href="#"
                                    class="block rounded-lg py-2 pl-6 pr-3 text-sm/7 font-semibold text-gray-900 hover:bg-gray-50">Contact sales</a>
                            </div>
                        </div>
                        <a href="#"
