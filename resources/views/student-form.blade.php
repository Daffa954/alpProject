...
<body class="w-full relative">
    <!-- Gambar diletakkan di bagian bawah kiri dan kanan dengan positioning absolute -->
    <img src="images/aset1.png" alt="" class="absolute -bottom-10 left-[-90px] md:left-[-30px] lg:left-[-40px] w-[300px] sm:w-[400px] md:w-[450px] lg:w-[450px] mb-4">
    <img src="images/aset3.png" alt="" class="absolute -bottom-4 right-[3px] md:right-[-20px] lg:right-[0px] w-[260px] sm:w-[400px] md:w-[450px] lg:w-[450px] mb-4">
    
    <x-navbar2></x-navbar2>
    
    <main class="ps-8 pe-8 pb-2">
        <div class="m-auto w-full xl:w-[60%] border-[1px] border-slate-400 bg-[#f4f4f47e] rounded-lg shadow-lg p-8 relative z-10">
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                <h1 class="text-3xl font-extrabold text-center text-indigo-700 mb-6">Form Pendaftaran Ekstrakurikuler</h1>
                @csrf
                <div>
                ...
                <div>
                    <label for="ekstrakurikuler" class="block text-sm font-semibold text-gray-700">Ekstrakurikuler</label>
